...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
!SLIDE!
<div style="background: url(Hubble_ultra_deep_field.jpg); color: white;">

h2. The golf analogy is way too flattering.

%step_list
* Suppose there are 150 moves left.
~* Ignoring captures, there are 150! playouts, or roughly 6e+262.
~* Clearly, we aren't going to find the perfect game playout.
~* So what are the odds that the playouts are going to hit upon
anything close to what will happen if both players make one of
their 10 best moves at each turn?
~* That will reduce the number of possibilities by about 1e140, to 1e122, which looks much
better.
~* How much better?  Well, for comparison, there are on the order of 1e80 atoms in the observable universe.
~* So suppose you look out in the night sky on a random direction (not
      necessarily towards a star)
~* and think of an integer number of nanoseconds between 0 and 13 billion years.
~* Go out that far as the photon flies in that direction, and write your initials on
the closest atom to that spot.
~* Meanwhile, I'll pick an arbitrary atom by some other method, and look to see if it has your
   initials on it.
~* Assuming atomic graffiti isn't a widespread but heretofore unrecognized (by humans) blight, my odds of
finding your atom on the first shot are roughly 1e42 better than the Monte Carlo playout's odds of hitting a decent game.
...
http://commons.wikimedia.org/wiki/File:License_icon-fdl.svg</small>
</td>
</tr> </table>
%end
...
h3. Isn't even an explanation.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
h1. 2. Behaviorism, stimuli & response.

h3. Does.  Not.  Work.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
h1. 3. Generalized learning machine / sponge (analogous to an ideal computer).

h3. Doesn't fit the facts.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
h1. 4. Complex heterogeneous modular architecture (analogous to a real computer).

h3. Uh, did you say "complex"?  Couldn't we try something easy first?

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
h1. 5. Penrose quantum magic
...
theory, but with s/Roge Penrose/Stephen Wolfram/ and a few minor
consequential adjustments.
%end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
h1. 6. Massively parallel Monte Carlo system, "machine learning", etc.

%step
!golf-ball-cube-3.png!

We're back to "isn't even an explanation".
%end
...
!SLIDE
   ...
   structural decomposition to the "there's a Tarring machine in my
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
h1. So what other modules might there be?
